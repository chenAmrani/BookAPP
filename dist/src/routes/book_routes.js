...
const authorOrAdminMiddleware_1 = __importDefault(require("../common/authorOrAdminMiddleware"));
...
router.post("/", auth_middleware_1.default, authorOrAdminMiddleware_1.default, book_controller_1.default.post.bind(book_controller_1.default));
router.put("/:id", auth_middleware_1.default, book_controller_1.default.putById.bind(book_controller_1.default));
router.delete("/:id", auth_middleware_1.default, book_controller_1.default.deleteById.bind(book_controller_1.default));
