...
router.post("/", book_controller_1.default.post.bind(book_controller_1.default));
router.put("/:id", book_controller_1.default.putById.bind(book_controller_1.default));
router.delete("/:id", book_controller_1.default.deleteById.bind(book_controller_1.default));
