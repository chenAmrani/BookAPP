...
const verifyOwnerBook_1 = __importDefault(require("../common/verifyOwnerBook"));
...
router.put("/updateOwnBook/:id", auth_middleware_1.default, verifyOwnerBook_1.default, book_controller_1.default.putById.bind(book_controller_1.default));
router.delete("/:id", auth_middleware_1.default, verifyOwnerBook_1.default, book_controller_1.default.deleteById.bind(book_controller_1.default));
